...
class wally_tx_witness_item(Structure):
    _fields_ = [("witness", c_void_p), ("len", c_size_t)]


class wally_tx_witness_stack(Structure):
    _fields_ = [("items", POINTER(wally_tx_witness_item)), ("num_items", c_size_t), ("items_allocation_len", c_size_t)]
...
class wally_map_item(Structure):
    _fields_ = [("key", c_void_p), ("key_len", c_size_t), ("value", c_void_p), ("value_len", c_size_t)]


class wally_map(Structure):
    _fields_ = [
        ("items", POINTER(wally_map_item)),
        ("num_items", c_size_t),
...
for f in (
    ...
    (
        ...
        c_int,
        [POINTER(ext_key), c_uint_p, c_size_t, c_uint32, POINTER(POINTER(ext_key))],
    ),
    ...
    (
        ...
        c_int,
        [POINTER(ext_key), c_char_p, c_uint32, c_uint32, POINTER(POINTER(ext_key))],
    ),
    (
        "bip32_key_from_parent_path_str_n",
        c_int,
        [POINTER(ext_key), c_char_p, c_size_t, c_uint32, c_uint32, POINTER(ext_key)],
    ),
    (
        "bip32_key_from_parent_path_str_n_alloc",
        c_int,
        [POINTER(ext_key), c_char_p, c_size_t, c_uint32, c_uint32, POINTER(POINTER(ext_key))],
    ),
    ...
    (
        ...
        c_int,
        [c_void_p, c_size_t, c_uint32, c_void_p, c_size_t, c_uint32, POINTER(ext_key)],
    ),
    (
        "bip32_key_from_seed_custom_alloc",
        c_int,
        [c_void_p, c_size_t, c_uint32, c_void_p, c_size_t, c_uint32, POINTER(POINTER(ext_key))],
    ),
    ...
    (
        ...
        c_int,
        [POINTER(ext_key), c_uint_p, c_size_t, c_uint32, POINTER(ext_key)],
    ),
    (
    ...
    (
        ...
        c_int,
        [c_char_p, c_size_t, c_char_p, c_size_t, c_uint32, c_void_p, c_size_t, c_size_t_p],
    ),
    ...
    (
        "wally_ae_sig_from_bytes",
        c_int,
        [c_void_p, c_size_t, c_void_p, c_size_t, c_void_p, c_size_t, c_uint32, c_void_p, c_size_t],
    ),
    (
        "wally_ae_signer_commit_from_bytes",
        c_int,
        [c_void_p, c_size_t, c_void_p, c_size_t, c_void_p, c_size_t, c_uint32, c_void_p, c_size_t],
    ),
    (
        "wally_ae_verify",
        c_int,
        [c_void_p, c_size_t, c_void_p, c_size_t, c_void_p, c_size_t, c_void_p, c_size_t, c_uint32, c_void_p, c_size_t],
    ),
    ("wally_aes", c_int, [c_void_p, c_size_t, c_void_p, c_size_t, c_uint32, c_void_p, c_size_t]),
    (
        "wally_aes_cbc",
        c_int,
        [c_void_p, c_size_t, c_void_p, c_size_t, c_void_p, c_size_t, c_uint32, c_void_p, c_size_t, c_size_t_p],
    ),
    ...
    (
        ...
        c_int,
        [POINTER(c_uint64), c_size_t, c_size_t, c_void_p, c_size_t, c_void_p, c_size_t, c_void_p, c_size_t],
    ),
    ...
    (
        ...
        c_int,
        [c_char_p, c_char_p, c_char_p, c_void_p, c_size_t, c_char_p_p],
    ),
    ...
    (
        ...
        c_int,
        [c_void_p, c_size_t, c_void_p, c_size_t, c_uint32, c_void_p, c_size_t, c_size_t_p],
    ),
    (
    ...
    (
        ...
        c_int,
        [c_void_p, c_size_t, c_uint64, c_void_p, c_size_t, c_void_p, c_size_t],
    ),
    (
        "wally_explicit_surjectionproof",
        c_int,
    ...
    (
        ...
        c_int,
        [c_void_p, c_size_t, c_void_p, c_size_t, c_uint32, c_uint32, c_void_p, c_size_t],
    ),
    (
    ...
    (
        "wally_psbt_input_generate_explicit_proofs",
        c_int,
        [
            POINTER(wally_psbt_input),
            c_uint64,
            c_void_p,
            c_size_t,
            c_void_p,
    ...
    (
        "wally_psbt_input_get_inflation_keys_blinding_rangeproof",
        c_int,
        [POINTER(wally_psbt_input), c_void_p, c_size_t, c_size_t_p],
    ),
    ("wally_psbt_input_get_inflation_keys_blinding_rangeproof_len", c_int, [POINTER(wally_psbt_input), c_size_t_p]),
    (
        "wally_psbt_input_get_inflation_keys_commitment",
        c_int,
        [POINTER(wally_psbt_input), c_void_p, c_size_t, c_size_t_p],
    ),
    ...
    (
        "wally_psbt_input_keypath_add",
        c_int,
        [POINTER(wally_psbt_input), c_void_p, c_size_t, c_void_p, c_size_t, c_uint_p, c_size_t],
    ),
    ...
    (
        ...
        c_int,
        [POINTER(wally_psbt_input), c_void_p, c_size_t],
    ),
    ...
    (
        ...
        c_int,
        [POINTER(wally_psbt_output), c_void_p, c_size_t, c_size_t_p],
    ),
    ...
    (
        "wally_psbt_output_get_asset_surjectionproof",
        c_int,
        [POINTER(wally_psbt_output), c_void_p, c_size_t, c_size_t_p],
    ),
    ...
    (
        "wally_psbt_output_get_value_blinding_rangeproof",
        c_int,
        [POINTER(wally_psbt_output), c_void_p, c_size_t, c_size_t_p],
    ),
    ...
    (
        ...
        c_int,
        [POINTER(wally_psbt_output), c_void_p, c_size_t, c_void_p, c_size_t, c_uint_p, c_size_t],
    ),
    ...
    (
        ...
        c_int,
        [c_void_p, c_size_t, c_void_p, c_size_t, c_void_p, c_size_t, c_uint32, c_void_p, c_size_t, c_void_p, c_size_t],
    ),
    ...
    (
        ...
        c_int,
        [c_void_p, c_size_t, c_uint32, c_uint32, c_void_p, c_size_t, c_size_t_p],
    ),
    (
    ...
    (
        ...
        c_int,
        [c_void_p, c_size_t, c_void_p, c_size_t, c_uint_p, c_size_t, c_uint32, c_void_p, c_size_t, c_size_t_p],
    ),
    (
        "wally_scriptsig_p2pkh_from_der",
        c_int,
        [c_void_p, c_size_t, c_void_p, c_size_t, c_void_p, c_size_t, c_size_t_p],
    ),
    (
    ...
    (
        "wally_scrypt",
        c_int,
        [c_void_p, c_size_t, c_void_p, c_size_t, c_uint32, c_uint32, c_uint32, c_void_p, c_size_t],
    ),
    ...
    (
        ...
        [
            ...
            c_void_p,
            c_size_t,
            POINTER(wally_tx_witness_stack),
            c_void_p,
            c_size_t,
            c_void_p,
            c_size_t,
    ...
    (
        "wally_tx_add_elements_raw_output_at",
        c_int,
        [
            POINTER(wally_tx),
            c_uint32,
    ...
    (
        ...
        [
            ...
            c_size_t,
            POINTER(wally_tx_witness_stack),
            POINTER(POINTER(wally_tx_input)),
        ],
    ),
    ...
    (
        "wally_tx_elements_issuance_calculate_reissuance_token",
        c_int,
        [c_void_p, c_size_t, c_uint32, c_void_p, c_size_t],
    ),
    (
        "wally_tx_elements_issuance_generate_entropy",
        c_int,
        [c_void_p, c_size_t, c_uint32, c_void_p, c_size_t, c_void_p, c_size_t],
    ),
    ...
    (
        ...
        [
            ...
            c_void_p,
            c_size_t,
            POINTER(POINTER(wally_tx_output)),
        ],
    ),
    ...
    (
        ...
        c_int,
        [POINTER(wally_tx), c_size_t, c_void_p, c_size_t, c_uint64, c_uint32, c_uint32, c_void_p, c_size_t],
    ),
    (
        "wally_tx_get_elements_signature_hash",
        c_int,
        [POINTER(wally_tx), c_size_t, c_void_p, c_size_t, c_void_p, c_size_t, c_uint32, c_uint32, c_void_p, c_size_t],
    ),
    ...
    (
        ...
        c_int,
        [POINTER(wally_tx_witness_stack), POINTER(POINTER(wally_tx_witness_stack))],
    ),
    ...
    (
        ...
        [
            ...
            c_size_t,
            c_uint32,
            POINTER(POINTER(wally_tx_witness_stack)),
        ],
    ),
    (
        "wally_witness_p2wpkh_from_der",
        c_int,
        [c_void_p, c_size_t, c_void_p, c_size_t, POINTER(POINTER(wally_tx_witness_stack))],
    ),
    (
        "wally_witness_p2wpkh_from_sig",
        c_int,
        [c_void_p, c_size_t, c_void_p, c_size_t, c_uint32, POINTER(POINTER(wally_tx_witness_stack))],
    ),
    ...
    (
        "wally_psbt_generate_input_explicit_proofs",
        c_int,
        [
            POINTER(wally_psbt),
            c_size_t,
    ...
    (
        "wally_psbt_get_input_asset_surjectionproof",
        c_int,
        [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t, c_size_t_p],
    ),
    ("wally_psbt_get_input_asset_surjectionproof_len", c_int, [POINTER(wally_psbt), c_size_t, c_size_t_p]),
    (
        "wally_psbt_get_input_best_utxo_alloc",
        c_int,
        [POINTER(wally_psbt), c_size_t, POINTER(POINTER(wally_tx_output))],
    ),
    ...
    (
        "wally_psbt_get_input_final_witness_alloc",
        c_int,
        [POINTER(wally_psbt), c_size_t, POINTER(POINTER(wally_tx_witness_stack))],
    ),
    ("wally_psbt_get_input_inflation_keys", c_int, [POINTER(wally_psbt), c_size_t, c_uint64_p]),
    (
        "wally_psbt_get_input_inflation_keys_blinding_rangeproof",
        c_int,
        [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t, c_size_t_p],
    ),
    (
        "wally_psbt_get_input_inflation_keys_blinding_rangeproof_len",
        c_int,
        [POINTER(wally_psbt), c_size_t, c_size_t_p],
    ),
    (
        "wally_psbt_get_input_inflation_keys_commitment",
        c_int,
        [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t, c_size_t_p],
    ),
    ("wally_psbt_get_input_inflation_keys_commitment_len", c_int, [POINTER(wally_psbt), c_size_t, c_size_t_p]),
    (
        "wally_psbt_get_input_inflation_keys_rangeproof",
        c_int,
        [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t, c_size_t_p],
    ),
    ...
    (
        "wally_psbt_get_input_issuance_amount_blinding_rangeproof",
        c_int,
        [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t, c_size_t_p],
    ),
    (
        "wally_psbt_get_input_issuance_amount_blinding_rangeproof_len",
        c_int,
        [POINTER(wally_psbt), c_size_t, c_size_t_p],
    ),
    (
        "wally_psbt_get_input_issuance_amount_commitment",
        c_int,
        [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t, c_size_t_p],
    ),
    ("wally_psbt_get_input_issuance_amount_commitment_len", c_int, [POINTER(wally_psbt), c_size_t, c_size_t_p]),
    (
        "wally_psbt_get_input_issuance_amount_rangeproof",
        c_int,
        [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t, c_size_t_p],
    ),
    ("wally_psbt_get_input_issuance_amount_rangeproof_len", c_int, [POINTER(wally_psbt), c_size_t, c_size_t_p]),
    (
        "wally_psbt_get_input_issuance_asset_entropy",
        c_int,
        [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t, c_size_t_p],
    ),
    ("wally_psbt_get_input_issuance_asset_entropy_len", c_int, [POINTER(wally_psbt), c_size_t, c_size_t_p]),
    (
        "wally_psbt_get_input_issuance_blinding_nonce",
        c_int,
        [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t, c_size_t_p],
    ),
    ...
    ("wally_psbt_get_input_required_locktime", c_int, [POINTER(wally_psbt), c_size_t, c_size_t_p]),
    ("wally_psbt_get_input_sequence", c_int, [POINTER(wally_psbt), c_size_t, c_size_t_p]),
    ("wally_psbt_get_input_sighash", c_int, [POINTER(wally_psbt), c_size_t, c_size_t_p]),
    (
        "wally_psbt_get_input_signature",
        c_int,
        [POINTER(wally_psbt), c_size_t, c_size_t, c_void_p, c_size_t, c_size_t_p],
    ),
    ...
    (
        "wally_psbt_get_input_witness_utxo_alloc",
        c_int,
        [POINTER(wally_psbt), c_size_t, POINTER(POINTER(wally_tx_output))],
    ),
    ...
    (
        "wally_psbt_get_output_asset_blinding_surjectionproof",
        c_int,
        [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t, c_size_t_p],
    ),
    ...
    (
        "wally_psbt_get_output_asset_surjectionproof",
        c_int,
        [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t, c_size_t_p],
    ),
    ...
    (
        "wally_psbt_get_output_blinding_public_key",
        c_int,
        [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t, c_size_t_p],
    ),
    ...
    (
        "wally_psbt_get_output_value_blinding_rangeproof",
        c_int,
        [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t, c_size_t_p],
    ),
    ...
    (
        "wally_psbt_set_input_inflation_keys_blinding_rangeproof",
        c_int,
    ...
    (
        "wally_psbt_set_input_issuance_amount_blinding_rangeproof",
        c_int,
        [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t],
    ),
    ...
    (
        "wally_psbt_set_output_asset_blinding_surjectionproof",
        c_int,
        [POINTER(wally_psbt), c_size_t, c_void_p, c_size_t],
    ),
    ...
    (
        "wally_tx_get_input_inflation_keys_rangeproof",
        c_int,
        [POINTER(wally_tx), c_size_t, c_void_p, c_size_t, c_size_t_p],
    ),
    ...
    (
        "wally_tx_get_input_issuance_amount_rangeproof",
        c_int,
        [POINTER(wally_tx), c_size_t, c_void_p, c_size_t, c_size_t_p],
    ),
    ...
    (
        "wally_tx_input_get_issuance_amount_rangeproof",
        c_int,
        [POINTER(wally_tx_input), c_void_p, c_size_t, c_size_t_p],
    ),
    ...
    def mkint(f):
        return lambda *args: int_fn_wrapper(f, *args)

    def mkint64(f):
        return lambda *args: int64_fn_wrapper(f, *args)

    def mkinstr(f, pos):
        return lambda *args: in_string_fn_wrapper(f, pos, *args)
